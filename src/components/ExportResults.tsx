...
export default function ExportResults({
  ...
  const exportAsImage = () => {
    ...
    ctx.fillText(
      `AA: ${wcagAA.normal ? "Pass" : "Fail"} (Normal), ${wcagAA.large ? "Pass" : "Fail"} (Large)`,
      70,
      700,
    );
    ctx.fillText(
      `AAA: ${wcagAAA.normal ? "Pass" : "Fail"} (Normal), ${wcagAAA.large ? "Pass" : "Fail"} (Large)`,
      70,
      750,
    );
  ...
  const exportAsPDF = () => {
    ...
    doc.text(
      `AA: Normal ${wcagAA.normal ? "Pass" : "Fail"}, Large ${wcagAA.large ? "Pass" : "Fail"}`,
      14,
      65,
    );
    doc.text(
      `AAA: Normal ${wcagAAA.normal ? "Pass" : "Fail"}, Large ${wcagAAA.large ? "Pass" : "Fail"}`,
      14,
      73,
    );
  ...
  return (
    <div className="glass-morphism p-6 rounded-xl">
      ...
      <div className="mb-6 grid grid-cols-3 gap-4">
        ...
        >
          <svg
            className="w-6 h-6 text-blue-400 mb-2 group-hover:scale-110 transition-transform"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
        ...
        >
          <svg
            className="w-6 h-6 text-red-400 mb-2 group-hover:scale-110 transition-transform"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <svg
            className="w-6 h-6 text-green-400 mb-2 group-hover:scale-110 transition-transform"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          <div className="p-3 bg-blue-500/10 rounded-lg border border-blue-500/20">
            ...
            <div className="space-y-1 text-sm text-gray-300">
              <div className="flex items-center">
                <span
                  className={`w-5 h-5 mr-2 rounded-full flex items-center justify-center ${wcagAA.normal ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"}`}
                >
                  {wcagAA.normal ? "✓" : "✗"}
                </span>
              ...
              <div className="flex items-center">
                <span
                  className={`w-5 h-5 mr-2 rounded-full flex items-center justify-center ${wcagAA.large ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"}`}
                >
                  {wcagAA.large ? "✓" : "✗"}
                </span>
          ...
          <div className="p-3 bg-purple-500/10 rounded-lg border border-purple-500/20">
            ...
            <div className="space-y-1 text-sm text-gray-300">
              <div className="flex items-center">
                <span
                  className={`w-5 h-5 mr-2 rounded-full flex items-center justify-center ${wcagAAA.normal ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"}`}
                >
                  {wcagAAA.normal ? "✓" : "✗"}
                </span>
              ...
              <div className="flex items-center">
                <span
                  className={`w-5 h-5 mr-2 rounded-full flex items-center justify-center ${wcagAAA.large ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"}`}
                >
                  {wcagAAA.large ? "✓" : "✗"}
                </span>
        ...
        <div className="mt-6 pt-4 border-t border-white/10 text-center text-xs text-muted-foreground">
          Generated with Accessibility Color Checker •{" "}
